// Fenir cada ECMA con sus funcionalidades. Ejemplos 
/*
//ECMA 7
...
console.log(nombre.trim()) //Elimino espacios tanto por derecha como por izquierda
console.log(nombre.trimEnd()) //Elimino espacio por derecha
console.log(nombre.trimStart()) //Elimino espacios por izquierda
...
console.log(sumarSueldos(sueldosEmpresa.flat(3)))*/  // remueve anidaciones internas dentro de un arrays. Infinity elimira todas la cantidad de anidaciones 
